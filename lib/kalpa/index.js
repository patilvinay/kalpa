...
//* ************************************************************************************** */
async function __process(obj, globalData) {
...
function process(obj, globalData) {
  console.log(obj)


  //  console.log(JSON.stringify(obj, null, 4))
  let rootData = _.get(obj, ['rootData']);
  let Var = _.get(rootData, ['kalpa']);
  console.log(Var)
  //let VarsFile = (_.find(Var, 'vars_file'));

  //  _loadVarFile(VarsFile)
  Var = (_.find(Var, 'vars'));
  ...
  if (Var !== undefined) {
    ...
    const data = YAML.stringify(JSON.parse(str2));
